<template>
	<div class="bg-white border border-t-0 rounded-b-2xl">
		<div class="flex flex-col  relative">
			<div v-if="gdstatus != '1' || avifsupportstatus != '1' " class="p-4 bg-red-700 text-white flex flex-col md:flex-row justify-between items-center">
				<span class="text-center md:text-left">Php GD Extension or libavif is not installed/enabled. Please contact the server admin!</span>
