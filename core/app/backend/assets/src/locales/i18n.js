...
const i18n = createI18n({
	...
	messages: {
		en: {
            ...
            ccover: "Consumed all of the allocated API calls",
			active: "Active",
			inactive: "Inactive",
		...
		es: {
            ...
            ccover: "Se consumieron todas las llamadas API asignadas",
			active: "Activo",
			inactive: "Inactivo",
		...
		bn: {
            ...
            ccover: "সমস্ত বরাদ্দকৃত API কলগুলি ফুরিয়ে গেছে।",
			active: "সক্রিয়",
			inactive: "নিষ্ক্রিয়",
		...
		de: {
            ...
            ccover: "Alle zugewiesenen API-Aufrufe verbraucht",
			active: "Aktiv",
			inactive: "Inaktiv",
		...
		hi: {
            ...
            ccover: "सभी आवंटित API कॉल का उपभोग किया गया",
			active: "सक्रिय",
			inactive: "निष्क्रिय",
		...
		fr: {
            ...
            ccover: "A consommé tous les appels d'API alloués",
			active: "Actif",
			inactive: "Inactif",
		...
		ru: {
            ...
            ccover: "Использованы все выделенные вызовы API.",
			active: "Активный",
			inactive: "Неактивный",
